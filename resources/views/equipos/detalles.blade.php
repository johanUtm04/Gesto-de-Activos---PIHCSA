...
<div class="d-flex justify-content-between align-items-center no-print">
    ...
    <div>
        ...
        <a href="{{ route('equipos.index') }}" class="btn btn-outline-secondary btn-lg ml-2">
                ...
                <div class="col-md pl-md-5">
                    <div class="row">
                        <div class="col-sm-4 mb-3">
                            ...
                            <div class="value-text"><i class="fas fa-laptop mr-1"></i> {{ $equipo->tipo_equipo }}</div>
                        </div>
                        <div class="col-sm-4 mb-3">
                            <div class="label-header">Fabricante / Modelo</div>
                            <div class="value-text">{{ $equipo->marca_equipo }}</div>
                        </div>
                        <div class="col-sm-4 mb-3">
